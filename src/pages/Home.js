...
fetch("https://prod-api.ioscan.de:4000/validators")
...
fetch("https://prod-api.ioscan.de:4000/transfercount")
  .then((response) => response.json())
  .then((data) => {
...
fetch("https://prod-api.ioscan.de:4000/signedextrinsiccnt")
  .then((response) => response.json())
  .then((data) => {
...
fetch("https://prod-api.ioscan.de:4000/topholdercnt")
  .then((response) => response.json())
  .then((data) => {
...
fetch("https://explorer.ioscan.de/response.json")
  .then((response) => response.json())
  .then((data) => {
...
fetch("https://wallet.iogoods.de/network")
  .then((response) => response.json())
  .then((data) => {
...
const Home = () => {
  ...
  const getInfo = async () => {
    const wsProvider = new WsProvider("wss://rpc2.iogoods.de");
        ...
        <div className="list-container home-info-container">
          ...
          <div className="home-info">
            ...
            <div className="home-info-content">
              ...
              <div className="home-info-value">{totalInsurance} MIO</div>
            </div>
          </div>
          <div className="home-info">
            <div className="home-info-icon graph-home-icon"></div>
